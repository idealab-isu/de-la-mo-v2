...
(script_to_generate,
 ...
 layer_boundary_template) = process.output_filenames("08_Curved_No_Delam",phase="ORIGINAL")
...
Mold = LayerMold.FromFile(os.path.join("..","data","CurvedMold2.STEP"))
...
layer1.singlepart.fe_part.Surface(name="ForceSurface",
                                  side1Faces=layer1.singlepart.GetPartFace((0.0,0.0,4.81),0.1))
...
FEModel.SurfaceTraction(name="SurfaceTraction_%d" % (DM.get_unique()),
                        createStepName=ApplyForceStep.name,
                        region=layer1.singlepart.GetInstanceFaceRegionSurface((0.0,0.0,4.81),0.1),
