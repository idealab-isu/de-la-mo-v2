...
class OCCModelBuilder(object):
    ...
    def process_delamination(self,layerbody1,facebody1,layerbody2,facebody2,delam_outline,gapwidth):
        ...
        (loop of 3D coordinates, hopefully projected onto the faces): 
           ...
           2. Create an offset curve a distance of gapwidth inside delam_outline
            ...
            for lb2cnt in range(len(layer2.BodyList)):
                ...
                for CommonFace in CommonFaces:
                    for delamination in delaminationlist:
                        (replacement_lb1,replacement_lb2)=self.process_delamination(lb1,CommonFace,lb2,CommonFaces[CommonFace],delam_outline,gapwidth):
